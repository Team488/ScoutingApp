...
export const EventTypes: { [index:number] : MatchEvent } = {
  ...
  25: { phase: "sandstorm", description: "Scored hatch on front rocket bottom"},
  27: { phase: "sandstorm", description: "Scored hatch on front rocket middle"},
  29: { phase: "sandstorm", description: "Scored hatch on front rocket top"},
  24: { phase: "sandstorm", description: "Scored hatch on back rocket bottom"},
  26: { phase: "sandstorm", description: "Scored hatch on back rocket middle"},
  28: { phase: "sandstorm", description: "Scored hatch on back rocket top"},
